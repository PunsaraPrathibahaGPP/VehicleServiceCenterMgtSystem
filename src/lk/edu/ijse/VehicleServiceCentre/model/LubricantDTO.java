 ...
 * @author ACER
 */
public class LubricantDTO extends SuperDTO{
    private String Lub_ID;
    ...
    public LubricantDTO(String Lub_ID, String Techni_ID, String Techni_Name, String Lub_Type, double Service_Fee, double LubricantFee, double Total_Fee) {
        this.Lub_ID = Lub_ID;
    ...
    /**
     * @param Lub_ID the Lub_ID to set
     */
