 ...
 * @author ACER
 */
public class RepairDTO extends SuperDTO{
    private String R_ID;
    ...
    public RepairDTO(String R_ID, String Techni_ID, String Techni_Name, String R_Type, double R_Fee, double Other_Fees, double Total_Fees) {
        this.R_ID = R_ID;
